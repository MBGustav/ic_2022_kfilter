...
int main(int argc, char *argv[]) {
  ...
  std::vector<float> a_matrix(kMatsize * kNumMatrices);
  std::vector<float> b_matrix(kMatsize * kNumMatrices);
  std::vector<float> c_matrix(kMatsize * kNumMatrices);
  ...
  // MM algorithm
  std::vector<float> c_reference(kMatsize * kNumMatrices);
  ...
  MatmulImpl<float, kRows, kCommon, kCols, kTileA, kTileB, TransB, kNumMatrices>(
